...
const Product = ({ post }) => {
  ...
  return (
    <div
      onClick={viewDetails}
      className="flex flex-col items-center justify-between hover:scale-110 transition duration-300 ease-in gap-3 p-4 mt-10 ml-5 rounded-xl outline cursor-pointer"
    >
      <div>
